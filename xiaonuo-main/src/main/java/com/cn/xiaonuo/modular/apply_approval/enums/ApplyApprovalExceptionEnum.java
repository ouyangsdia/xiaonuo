 ...
 */
package com.cn.xiaonuo.modular.apply_approval.enums;
...
public enum ApplyApprovalExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        ApplyApprovalExceptionEnum(Integer code, String message) {
        this.code = code;
