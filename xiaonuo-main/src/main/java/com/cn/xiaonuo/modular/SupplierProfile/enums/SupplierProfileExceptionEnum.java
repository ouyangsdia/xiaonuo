 ...
 */
package com.cn.xiaonuo.modular.SupplierProfile.enums;
...
public enum SupplierProfileExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        SupplierProfileExceptionEnum(Integer code, String message) {
        this.code = code;
